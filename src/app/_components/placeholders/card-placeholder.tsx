...
export const CardPlaceholder: React.FC<CardPlaceholderProps> = ({
  ...
  return (
    <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 gap-2 ${className}`}>
      {counts.map((item) => (
        <div
        ...
        >
          <div className="flex items-center justify-center h-48 mb-4 bg-gray-500 rounded">
            <svg
